  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Gestion des directions</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-1">Gérez les directions, services et agents</p>
        ...
        <div>
          {Object.entries(groupedDirections).length === 0 ? (
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Aucune direction</h3>
              <p className="text-gray-500 dark:text-gray-400">Commencez par créer une direction</p>
              <button
                onClick={() => setShowModal(true)}
            ...
            Object.entries(groupedDirections).map(([categorie, dirs]) => (
              <div key={categorie} className="mb-6">
                <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3 px-2">
                ...
                <div className="space-y-3">
                  {dirs.map((direction) => {
                    ...
                    return (
                      <div key={direction.id_direction} className="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">{direction.nom_direction}</h3>
                                <span className="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full dark:bg-slate-700 dark:text-gray-300">
                                  {direction.categorie || 'Non catégorisé'}
                                </span>
                              </div>
                              
                              {direction.description && (
                                <p className="text-gray-600 dark:text-gray-300 text-sm ml-8 mb-3">{direction.description}</p>
                              )}
                                ...
                                <div className="mb-4">
                                  ...
                                  <div className="space-y-2">
                                    {directionServices.map((service) => (
                                      <div key={service.id_service} className="bg-white dark:bg-slate-800 rounded-lg p-3 shadow-sm">
                                        <div className="flex justify-between items-start">
                                          <div className="flex-1">
                                            <h5 className="font-medium text-gray-800 dark:text-gray-100">{service.nom_service}</h5>
                                          ...
                                          <div className="flex gap-1">
                                            <button onClick={() => handleEditService(service)} className="p-1 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded">
                                              <PencilIcon className="h-4 w-4" />
                                            </button>
                                            <button onClick={() => handleDeleteService(service.id_service, service.nom_service)} className="p-1 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded">
                                ...
                                <div>
                                  ...
                                  <div className="space-y-1">
                                    {directionUsers.map((user) => (
                                      <div key={user.id_utilisateur} className="flex justify-between items-center p-2 bg-white dark:bg-slate-800 rounded-lg">
                                        <div className="flex items-center gap-2">
                                          ...
                                          <div>
                                            ...
                                            <div className="flex flex-wrap items-center gap-2 mt-0.5">
                                              <span className="text-xs px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full dark:bg-blue-900/30 dark:text-blue-300">
              ...
              <div key={service.id_service} className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{direction?.nom_direction || 'Direction inconnue'}</p>
                  </div>
                </div>
                {service.description && <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">{service.description}</p>}
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="h-8 w-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                                <span className="text-blue-600 dark:text-blue-300 font-medium">{agent.prenom?.charAt(0)}{agent.nom?.charAt(0)}</span>
                              </div>
                              <div className="ml-3">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-4 border-b dark:border-slate-700 sticky top-0 bg-white dark:bg-slate-800">
            ...
            <form onSubmit={handleSubmitDirection} className="p-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-gray-800 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  required
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t dark:border-slate-700">
                <button type="button" onClick={closeModal} className="px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                  Annuler
                </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-lg w-full">
            ...
            <form onSubmit={handleSubmitService} className="p-4 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Nom du service <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button type="button" onClick={closeServiceModal} className="px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                  Annuler
                </button>
                <button type="submit" disabled={loading} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors">
